...
export default function CallToGive() {
  return (
    <section
      id="give"
      className="relative bg-secondary text-secondary-foreground py-20"
    >
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="max-w-md mx-auto bg-card/50 backdrop-blur-sm p-8 rounded-lg shadow-lg border border-white/20">
          ...
          <div className="space-y-3 text-left text-lg bg-background/50 p-6 rounded-md border border-green-500/30">
            <p className="flex justify-between">
              <span className="text-muted-foreground">1. Go to M-Pesa Menu</span>
            </p>
            <p className="flex justify-between">
              <span className="text-muted-foreground">2. Select 'Lipa na M-Pesa'</span>
            </p>
            <p className="flex justify-between">
              <span className="text-muted-foreground">3. Pay Bill:</span>{' '}
              <strong className="text-white font-mono tracking-wider">159210</strong>
            </p>
            <p className="flex justify-between">
              <span className="text-muted-foreground">4. Account No:</span>{' '}
